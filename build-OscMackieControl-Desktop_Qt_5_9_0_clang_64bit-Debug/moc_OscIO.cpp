...
void OscIO::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (OscIO::*_t)(OscMessage * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OscIO::oscMessage)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject OscIO::staticMetaObject = {
...
void *OscIO::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OscIO.stringdata0))
        return static_cast<void*>(const_cast< OscIO*>(this));
