...
void MidiIO::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (MidiIO::*)(const int , const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiNoteOff)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MidiIO::*)(const int , const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiNoteOn)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (MidiIO::*)(const int , const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiKeyPressure)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (MidiIO::*)(const int , const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiControler)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (MidiIO::*)(const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiProgram)) {
                *result = 4;
                return;
            }
        }
        {
            using _t = void (MidiIO::*)(const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiChannelPressure)) {
                *result = 5;
                return;
            }
        }
        {
            using _t = void (MidiIO::*)(const int , const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiPitchBend)) {
                *result = 6;
                return;
            }
        }
        {
            using _t = void (MidiIO::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiSysex)) {
                *result = 7;
                return;
            }
        }
        {
            using _t = void (MidiIO::*)(const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiSystemCommon)) {
                *result = 8;
                return;
            }
        }
        {
            using _t = void (MidiIO::*)(const int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MidiIO::midiSystemRealtime)) {
                *result = 9;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MidiIO::staticMetaObject = {
